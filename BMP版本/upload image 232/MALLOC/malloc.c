...
__align(4) u8 raw_data[160000] __attribute__((at(0X68000000+2*MEM2_MAX_SIZE)));
__align(4) u8 out_data[160][1008] __attribute__((at(0X68000000+4*MEM2_MAX_SIZE)));
__align(4) u8 ComOutBuf[1024] __attribute__((at(0X68000000+6*MEM2_MAX_SIZE)));
//__align(4) u8 ComOutBuf[1024];
