...
__align(4) u8 raw_data[60*1024] __attribute__((at(0X68000000)));
__align(4) u8 out_data[240][1008] __attribute__((at(0X68000000+1*MEM2_MAX_SIZE)));
__align(4) u8 ComOutBuf[1024] __attribute__((at(0X68000000+60*1024)));
__align(4) volatile u8 inbuf_buf[15360] __attribute__((at(0X68000000+70*1024)));
